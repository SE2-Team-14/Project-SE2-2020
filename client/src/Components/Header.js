      ...
      {(context) => (
        ...
        <Navbar bg="info" variant="dark" expand="md" className='col-12'>
          ...
          <Nav className="mr-auto">
            ...
            {(context.authUser != null && context.authUser.role === "SupportOfficer") && <Nav.Link as={NavLink} to={`/support-officer-home/${context.authUser.email}/modify`} >Modify Schedule</Nav.Link>}
          </Nav>
